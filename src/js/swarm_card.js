...
avatarImage.src = `./assets/${users[0].avatar}`;
avatarImage.alt = users[0].nickname;
////
const nickname = document.createElement("h1");
nickname.classList = "swarm__main__container__item__nickname";
const nicknameText = document.createTextNode(users[0].nickname);
...
const ageText = document.createTextNode(users[0].age);
age.appendChild(ageText);

const distance = document.createElement("div");
distance.classList =
  "swarm__main__container__item__draught-distance  swarm__main__container__item__data";
const distanceText = document.createTextNode(users[0].distance);
...
const relationshipText = document.createTextNode(users[0].relationship);
...
const bioText = document.createTextNode(users[0].biography);
